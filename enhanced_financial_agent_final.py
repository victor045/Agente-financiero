"""
Enhanced Financial Agent - Versión Final con Visualización.
Combina lo mejor del agente funcional con visualización gráfica.
"""
...
###################
# Graph Visualization (Reutilizado del código existente)
###################
...
###################
# State Management (Reutilizado del código existente)
###################
...
###################
# Data Processing (Reutilizado del código existente)
###################
...
###################
# Question Interpreter (Reutilizado del código existente)
###################
...
###################
# Response Formatter (Reutilizado del código existente)
###################
...
###################
# Enhanced Financial Agent Final
###################

class EnhancedFinancialAgentFinal:
    """Agente financiero final con visualización y aclaraciones."""
    ...
    def __init__(self, config: FinancialAgentConfig = None):
        ...
        self.visualizer = LiveGraphVisualizer() if self.config.enable_graph_visualization else None
        self.current_state = None
        self.execution_history = []
        
        # Iniciar visualización en hilo separado si está habilitada
        if self.visualizer and self.config.enable_graph_visualization:
            ...
            time.sleep(2)  # Esperar a que se inicie la ventana
...
def main():
    ...
    print("🎯 ENHANCED FINANCIAL AGENT - VERSIÓN FINAL")
    print("=" * 60)
    ...
    # Crear agente
    agent = EnhancedFinancialAgentFinal()
