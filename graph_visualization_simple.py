"""
Visualización Simple del Grafo LangGraph sin Dependencias Complejas.
"""
...
try:
    ...
    print("💡 Instala las dependencias: pip install matplotlib networkx pandas")
    sys.exit(1)
...
class InteractiveFinancialAgentWithSimpleVisualization:
    ...
    def process_question_with_visualization(self, question):
        """Procesar pregunta con visualización."""
...
def main():
    ...
    print("🎯 FINANCIAL AGENT - VISUALIZACIÓN SIMPLE")
    print("=" * 60)
    ...
    print("   - ¿Cuál es el promedio de facturas?")
    print("=" * 60)
