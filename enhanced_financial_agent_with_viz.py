"""
Enhanced Financial Agent - Con Visualización y Preguntas de Aclaración.
...
class GraphVisualizer:
    """Visualizador del grafo del agente financiero."""
...
###################
# Question Interpreter with Clarification
###################
...
###################
# Enhanced Financial Agent with Visualization
###################

class EnhancedFinancialAgentWithViz:
    """Agente financiero mejorado con visualización y aclaraciones."""
    ...
    def __init__(self, config: FinancialAgentConfig = None):
        ...
        self.visualizer = GraphVisualizer() if self.config.enable_graph_visualization else None
...
def main():
    """Función principal del agente mejorado con visualización."""
    print("🎯 ENHANCED FINANCIAL AGENT - CON VISUALIZACIÓN")
    print("=" * 60)
    ...
    # Crear agente
    agent = EnhancedFinancialAgentWithViz()
